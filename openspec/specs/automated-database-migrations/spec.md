...
Define Glovelly's automated PostgreSQL schema migration workflow using checked-in EF Core migrations, a packaged EF migration bundle, Cloud Run Job execution, CI validation, and explicit deployment ordering.
