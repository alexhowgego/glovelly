...
Define reliability requirements for importing gig set lists from linked Google Sheets, including selected-resource behavior, shared Google authorization state, and user-facing import failures.
