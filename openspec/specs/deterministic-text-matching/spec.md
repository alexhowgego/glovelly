...
Domain-independent text normalization and string similarity utilities used by chart matching and other Glovelly features. This library is free of API-domain dependencies so it can be reused without coupling to Glovelly business models.
