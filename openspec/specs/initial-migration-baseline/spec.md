...
Define the one-time adoption workflow for registering existing Glovelly PostgreSQL databases into EF Core migration history without replaying baseline DDL against live domain schemas.
