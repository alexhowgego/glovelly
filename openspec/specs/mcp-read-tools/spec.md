...
Define the authenticated read-only MCP tools that expose Glovelly business data for agent-assisted gig, contact, resource, setlist, and expense-statement query workflows.
